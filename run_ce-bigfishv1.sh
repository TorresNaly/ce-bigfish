...
local_download_directory="/pl/active/onishimura_lab/PROJECTS/naly/bigfish/02_DG_quantification/WDMP91_smFISH/250204_WDMP91/4-cell/Bright"
input_directory="${local_download_directory}/input"
subdirectories=("$input_directory"/*)
python_script_path="/projects/naly@colostate.edu/bigfish/ce-bigfish/01_Ce-bigIFSH_single-embryo-3.py"
