...
#SBATCH --output="logs/%j-report.out"

# Set base directory and initialize paths


local_download_directory="/pl/active/onishimura_lab/PROJECTS/naly/bigfish/02_DG_quantification/N2_chs-1_set-3/250207_N2_chs-1/4-cell"
