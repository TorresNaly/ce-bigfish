...
# # # Note: input directory = image subdiorectory
# folder_name = '/pl/active/onishimura_lab/PROJECTS/naly/bigfish/02_DG_quantification/WDMP91_smFISH/250204_WDMP91/2-cell/Dark/input/05' #your folder should contain 2 images (.dv and its ref.dv)
...
#     output_directory = os.path.join(folder_name, "output")
